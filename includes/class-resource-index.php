...
class ResourceIndex {
	...
	/**
	 * Remove an index row by post ID.
	 */
	...
	/**
	 * Look up a row by URI.
	 *
	 * Returns array with keys: post_id, user_id, content_hash, excerpt — or null.
	 */
	...
	/**
	 * Get the content_hash for a post (empty string if not indexed).
	 */
	 ...
	 */
	public function rebuild_if_dirty( int $user_id, string $host ): void {
