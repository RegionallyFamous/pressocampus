...
class Plugin {
    ...
    public function register_post_status(): void {
        register_post_status('pressocampus_expired', [
    ...
    public function get_cpt(): CPT                     { return $this->cpt; }
    public function get_auth(): Auth                   { return $this->auth; }
    public function get_soul(): Soul                   { return $this->soul; }
    public function get_resource_index(): ResourceIndex { return $this->resource_index; }
    public function get_mcp_endpoint(): MCPEndpoint    { return $this->mcp_endpoint; }
    public function get_audit_log(): AuditLog          { return $this->audit_log; }
    public function get_cache(): Cache                 { return $this->cache; }
    public function get_oauth_server(): OAuthServer    { return $this->oauth_server; }
    public function get_discovery(): Discovery         { return $this->discovery; }
    public function get_onboarding(): Onboarding       { return $this->onboarding; }
}
